...
public class WarmstartUserRanking {

	public static void main(String[] args) {
		Set<Integer> allItems = Item.testItems(); // get all items

		String csvFile = "/Users/rotunb200/Documents/workspace/sample/src/sample/data/ml-1m.csv";
		String output = "/Users/rotunb200/Documents/workspace/sample/src/sample/data/warmstart/userranking/ml-1m.train.rating";
		String outputTestFile = "/Users/rotunb200/Documents/workspace/sample/src/sample/data/warmstart/userranking/ml-1m.test.rating";
		String outputPositives = "/Users/rotunb200/Documents/workspace/sample/src/sample/data/warmstart/userranking/ml-1m.test.positive";

		Set<Integer> testItems = new HashSet<Integer>(); // keep track of items
															// in test file
		...
		try (BufferedWriter bw = new BufferedWriter(new FileWriter(output));
			...
			while ((line = reader.readNext()) != null) {
				...
				/*
				 * make sure item is in list of all items
				 */
